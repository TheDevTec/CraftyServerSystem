...
public class SetSpawn extends CssCommand {
	...
	public void setSpawn(Position pos, CommandSender sender) {
		...
		if(sender != null)
			msg(sender, "set", renderer().placeholder("world", pos.getWorldName()).placeholder("x", pos.getX()).placeholder("y", pos.getY()).placeholder("z", pos.getZ())
			        .placeholder("yaw", pos.getYaw()).placeholder("pitch", pos.getPitch()));
	}
