...
public class Hologram implements HologramHolder {
	...
	static Object name = Ref.isBefore(12, 0) ? 2 : findDataWatcherObject(Ref.nms("world.entity", "Entity"), Optional.class);
	static {
		if(name == null)
			name = findDataWatcherObject(Ref.nms("world.entity", "Entity"), String.class);
	}
	static Object showName = Ref.isBefore(12, 0) ? 3 : findDataWatcherObject(Ref.nms("world.entity", "Entity"), Boolean.class);
	static Object properties = Ref.isBefore(12, 0)
	        ? 10
